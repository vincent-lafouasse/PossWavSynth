...
/**
 * \class Midi
 * \brief Midi object represents the entire content of a Midi file and is a
 * starting point to using Midi Parser
 *
 * Objects of this class represent the entire contents of a Midi file and
 * provide methods for reading the data stored in the file.
 */
class Midi
{
   public:
