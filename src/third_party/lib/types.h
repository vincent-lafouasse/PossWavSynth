...
struct MidiType
{
    ...
    typedef enum
    {
        ...
        SimTracks =
            1, /**< Files which contain multiple tracks played simultaneously */
        IndTracks =
            2 /**< Files which contain multiple tracks played independently */
    } FileFormat;
    ...
    typedef enum
    {
        ...
        NoteOn =
            0x90, /**< Note On event (considered Note Off if velocity is 0) */
        PolyphonicKeyPressure =
            0xA0, /**< Key pressure event after note was pressed (Aftertouch) */
